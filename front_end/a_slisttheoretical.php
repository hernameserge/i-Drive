...
<head>
    ...
    <title>Student Theoretical List</title>
    <style>
		table{
			table-layout:fixed;
		}
					...
					<table id="datatable-responsive" class="table table-bordered table-striped dt-responsive nowrap" cellspacing="0" width="100%">
						...
						<tbody>
							<?php 
								...
								$sql = "SELECT * FROM client_scheduleonly WHERE typeofexam = 'Theoretical Exam' AND date = '$date' AND typeoftime = 'Whole Day'";
							...
							<tr>
								...
								<td>
                                    <form action="a_utheoretical.php?date=<?php echo $date;?>" method="POST">
				...
				<div class="card-box table-responsive">
					<table id="datatable-responsive" class="table table-bordered table-striped dt-responsive nowrap" cellspacing="0" width="100%">
						...
						<tbody>
							<?php 
								require_once 'connection.php'; 
								$sql = "SELECT * FROM client_scheduleonly WHERE typeofexam = 'Theoretical Exam' AND date = '$date' AND typeoftime = 'Half Day'";
								$query = $conn->query($sql);
								while($row = $query->fetch_assoc()){						
							?>
