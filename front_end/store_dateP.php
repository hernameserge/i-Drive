...
<body>
    <div class="container-body">
        <form action="insert_scheduleP.php" method="POST">
            ...
            <div class="form-group" style="display:none;">
                ...
                <input type="text" class="form-control" name="exam" value="Practical Exam" required>
            </div>
            ...
            <div>
                <?php 
                    ...
                    $query = "SELECT typeoftime, COUNT(id) as count FROM client_schedule WHERE typeoftime = 'Whole Day' AND typeofexam = 'Practical Exam'";
            ...
            <div id="radioContainer3" class="radio-container">
                ...
                <?php 
                    require 'connection.php';
                    $query1 = "SELECT instructor, typeoftime, timestamp, COUNT(id) as count1 FROM client_schedule WHERE typeoftime = 'Whole Day' AND typeofexam = 'Practical Exam'";
                    $query_result1 = mysqli_query($conn, $query1);
                    ...
                    if($timestamp1 != "8:00AM - 4:00PM" || $timestamp1 != "8:00AM - 3:00PM" && mysqli_num_rows($query_result1) != 0){?>
                        ...
                        <div class="whole_day" id="whole_day">
                            ...
                            <?php 
                                require 'connection.php';
                                $query12 = "SELECT instructor_name, vehicle_type, available_date FROM instructor_schedule WHERE typeoftime = '$whole_daye' AND admin_approval = '2'";
                                ...
                                while($row1 = mysqli_fetch_assoc($query_result12)){
                                    ...
                                    $instructor_vehicle = $row1['vehicle_type'];
                            ...
                            ?>
                                        <div style="text-align:left;">
                                            ...
                                            <label for="age1"><?php echo $instructor_name .' - '. $instructor_vehicle; ?></label>
                                            <input type="hidden" name="vehicle_type" value="<?php echo $instructor_vehicle; ?>">
                                        </div>
                            <?php
                                    }
                                } 
                        ...
                        <div class="whole_day" id="whole_day1">
                            ...
                            <?php 
                                require 'connection.php';
                                $query12 = "SELECT instructor_name, vehicle_type, available_date FROM instructor_schedule WHERE typeoftime = '$half_daye' AND admin_approval = '2'";
                                $query_result12 = mysqli_query($conn, $query12);
                            ...
                            ?>
                                        <div style="text-align:left;">
                                            <input type="radio" id="age3" name="instructor" value="<?php echo $instructor_name;?>" required>
                                            <label for="age1"><?php echo $instructor_name .' - '. $instrctor_vehicle; ?></label>
                                        </div>
                            <?php
                                    }
                                } 
    ...
    <script>
        ...
        function toggleRadioContainerForWholeDay() {
            ...
            var inputField = document.getElementById("formdatesInput1");
            inputField.value = "<?php echo $whole_daye;?>";
