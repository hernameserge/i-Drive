					...
					<table id="datatable-responsive" class="table table-bordered table-striped dt-responsive nowrap" cellspacing="0" width="100%">
						...
						<tbody>
							<?php 
								...
								$sql = "SELECT * FROM client_scheduleonly WHERE typeofexam = 'Theoretical Exam' AND date = '$date' AND typeoftime = 'Whole Day' AND admin_approval = '2'";
							...
							<tr>
								...
								<td>
									<form action="t_attendance.php?date=<?php echo $date;?>" method="POST">
				...
				<div class="card-box table-responsive">
					<table id="datatable-responsive" class="table table-bordered table-striped dt-responsive nowrap" cellspacing="0" width="100%">
						...
						<tbody>
							<?php 
								require_once 'connection.php'; 
								$sql = "SELECT * FROM client_scheduleonly WHERE typeofexam = 'Theoretical Exam' AND date = '$date' AND typeoftime = 'Whole Day' AND admin_approval = '2' AND attendance = '2'";
								$query = $conn->query($sql);
								while($row = $query->fetch_assoc()){						
							?>
				...
				<div class="card-box table-responsive">
					<table id="datatable-responsive" class="table table-bordered table-striped dt-responsive nowrap" cellspacing="0" width="100%">
						...
						<tbody>
							<?php 
								require_once 'connection.php'; 
								$sql = "SELECT * FROM client_scheduleonly WHERE typeofexam = 'Theoretical Exam' AND date = '$date' AND typeoftime = 'Whole Day' AND admin_approval = '2' AND attendance = '1'";
								$query = $conn->query($sql);
								while($row = $query->fetch_assoc()){						
							?>
				...
				<div class="card-box table-responsive">
					<table id="datatable-responsive" class="table table-bordered table-striped dt-responsive nowrap" cellspacing="0" width="100%">
						...
						<tbody>
							<?php 
								require_once 'connection.php'; 
								$sql = "SELECT * FROM client_scheduleonly WHERE typeofexam = 'Theoretical Exam' AND date = '$date' AND typeoftime = 'Half Day' AND admin_approval = '2'";
								$query = $conn->query($sql);
								while($row = $query->fetch_assoc()){						
							?>
				...
				<div class="card-box table-responsive">
					<table id="datatable-responsive" class="table table-bordered table-striped dt-responsive nowrap" cellspacing="0" width="100%">
						...
						<tbody>
							<?php 
								require_once 'connection.php'; 
								$sql = "SELECT * FROM client_scheduleonly WHERE typeofexam = 'Theoretical Exam' AND date = '$date' AND typeoftime = 'Half Day' AND admin_approval = '2' AND attendance = '2'";
								$query = $conn->query($sql);
								while($row = $query->fetch_assoc()){						
							?>
				...
				<div class="card-box table-responsive">
					<table id="datatable-responsive" class="table table-bordered table-striped dt-responsive nowrap" cellspacing="0" width="100%">
						...
						<tbody>
							<?php 
								require_once 'connection.php'; 
								$sql = "SELECT * FROM client_scheduleonly WHERE typeofexam = 'Theoretical Exam' AND date = '$date' AND typeoftime = 'Half Day' AND admin_approval = '2' AND attendance = '1'";
								$query = $conn->query($sql);
								while($row = $query->fetch_assoc()){						
							?>
	...
	<div id="grading" class="modal fade" role="dialog">
		<div class="modal-dialog">
			...
			<div class="modal-body" style="padding:30px;">
					<form action="i_theoretical.php?date=<?php echo $date;?>" method="POST">
