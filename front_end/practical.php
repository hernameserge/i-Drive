...
date_default_timezone_set('Asia/Singapore');
    function build_calendar($month, $year){
        ...
        $stmt = $mysqli->prepare("select * from client_schedule where MONTH(date) = ? AND YEAR(date) = ? AND typeofexam = 'Practical Exam'");
        ...
        while($currentDay <= $numberDays){
            ...
            if($date < $currentDate){
                ...
                $calendar.="<td class='$today'><h4>$currentDay</h4> <a href='store_dateP.php?date=".$date."' class='btn btn-success btn-xs'>Book</a>";
            }
...
<body>
    ...
    <div>
        <center>
            <a href="student_viewingP.php">View All Schedule</a>
        </center>
    </div>
</body>
</html>