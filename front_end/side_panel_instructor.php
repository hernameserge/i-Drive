    ...
    <div class="profile-container">
        <div class="dropdown show">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                <a class="dropdown-item" href="instructor.php?page=logout"><div class="d-flex justify-content-between"><span>Log Out</span><i class="fa-solid fa-right-from-bracket"></div></i></a>
            </div>
        </div>
    </div>
</div>
<div id="mySidepanel" class="sidepanel">
    ...
    <div class="pr-3">
        <div class="account-name-container pl-3 mt-2" id="account-name">
            <h5 class="ms-2 text-center">Instructor</h5>
        </div>
        <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">×</a>
        <div id="buttons-container">
            <ul class="list-group">
                <li class="list-group-item">
                    <a href="instructor.php?page=instructor_scheduling">
